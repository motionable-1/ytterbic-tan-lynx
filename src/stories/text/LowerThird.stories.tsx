...
const meta: Meta<typeof LowerThird> = {
  ...
  argTypes: {
    lowerThirdStyle: {
      control: "select",
      options: ["minimal", "boxed", "accent", "split", "gradient"],
    },
    color: { control: "color" },
...
export const Boxed: Story = {
  render: () => (
    ...
    >
      <LowerThird
        title="Breaking News"
        subtitle="Live from the studio"
        lowerThirdStyle="boxed"
        color="#FF6B6B"
      />
    </AbsoluteFill>
  ),
...
export const AllStyles: Story = {
  ...
  render: () => (
    <AbsoluteFill>
      {(["minimal", "boxed", "accent", "split", "gradient"] as const).map(
        (s, i) => (
          <LowerThird
            key={s}
            title="Speaker Name"
